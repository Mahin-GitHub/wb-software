...
const ContactPageSkeleton = () => {
    return (
        <div>
            <div className="w-full h-auto mx-auto sm:mb-12 px-2 py-4 sm:my-8  animate-pulse space-y-4">
                {/* About Us Card */}
                <div className="w-full h-full mx-auto p-4 border border-gray-300 shadow-sm bg-white rounded-sm space-y-3">
                    <div className="h-8 w-32 bg-gray-300 rounded-md mx-auto"></div>
